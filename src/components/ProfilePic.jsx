      ...
      <>
        ...
        <Modal size="lg" data-bs-theme='dark' className="text-light" show={show} onHide={handleClose}>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formFileSm" className="mt-3" style={showMod ? { display: 'block' } : { display: 'none' }} >
              <Form.Label className="ms-2">Inserisci la tua immagine profilo</Form.Label>
              <div className=" d-flex">
                <Form.Control type="file" onChange={(e) => setFile(e.target.files[0])} />
                <Button variant="outline-light" type="submit"> Modifica </Button>
              </div>
            </Form.Group>

            <Modal.Footer className="p-0 ps-3">
              <div className="d-flex gap-3 me-auto my-0 ">
                <Button variant="outline-light" className="border-0 d-flex flex-column py-3 bg-grey" onClick={() => setShowMod(!showMod)}>
